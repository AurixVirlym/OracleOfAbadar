...
const commands = [
	...
	new SlashCommandBuilder().setName('createcardset')
		...
		new SlashCommandBuilder().setName('setmerge')
		.setDescription('Test Command.'),
	...
	new SlashCommandBuilder().setName('updatexpsystem2')
		.setDescription('Test Command.'),
	...
	new SlashCommandBuilder().setName('pullcard')
		.setDescription('Gives you one card. Usable once per day or if you have 10 RP. Daily pull is used before points.'),
