...
const commands = [
	...
	.addStringOption(option => option.setName('mention').setDescription('Player discord @mention.').setRequired(true))
	.addStringOption(option => option.setName('character').setDescription('Name of the new character, case sensitive.').setMinLength(1).setMaxLength(30).setRequired(true))
