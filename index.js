...
const PlayerData = mongoose.model(PlayerCollection, PlayerSchema)
const CharacterData = mongoose.model(CharacterCollection, CharacterSchema)
const ReportData = mongoose.model(ReportCollection, ReportSchema)
